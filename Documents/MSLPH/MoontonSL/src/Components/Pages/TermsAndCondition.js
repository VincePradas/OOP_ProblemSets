...
const TermsAndCondition = () => {
  return (
    <div className='mainContainer tac'>
        <section className="tacPageMLBB top">
            <div className="tacContentTop">
                ...
                <h5>User Conduct:</h5>
                <p>
                    Users of the MSL Philippines website must comply with all applicable laws and regulations. Users are prohibited from using the website for any illegal or unauthorized purpose, including but not limited to the following: <br /><br />
                    <ul>
                ...
                <p>
                    These Terms and Conditions constitute the entire agreement between MSL Philippines and website users and supersede all prior agreements or understandings, whether written or oral. <br /><br />
